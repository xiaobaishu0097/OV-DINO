...
# Pillow >= 10 moved resampling enums under Image.Resampling; reintroduce LINEAR alias if missing.
if not hasattr(Image, "LINEAR"):
    try:
        _linear_resample = Image.Resampling.BILINEAR  # type: ignore[attr-defined]
    except AttributeError:
        _linear_resample = Image.BILINEAR  # type: ignore[attr-defined]
    Image.LINEAR = _linear_resample  # type: ignore[attr-defined]
